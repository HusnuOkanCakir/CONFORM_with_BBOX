...
with torch.no_grad():
    args_config_file = "/content/drive/MyDrive/conform/CONFORM/detrex/projects/dino/configs/dino-swin/dino_swin_large_384_4scale_36ep.py" #----------CHANGE THIS ADDRESS------------------------------
    detector_cfg = LazyConfig.load(args_config_file)
    detector_cfg = LazyConfig.apply_overrides(detector_cfg, ['train.init_checkpoint=/content/drive/MyDrive/conform/CONFORM/dino_swin_large_384_4scale_36ep.pth']) #----------CHANGE THIS ADDRESS------------------------------
    ...
    # detect all images
    test_folder = "/content/drive/MyDrive/conform/CONFORM/result_outputs/" #----------CHANGE THIS ADDRESS------------------------------
    gt = "/content/drive/MyDrive/conform/CONFORM/datasets/vsr.pkl" #----------CHANGE THIS ADDRESS------------------------------
    ...
    for i in tqdm(range(10)):
        ...
        for idx_each, cate_each in enumerate(cate):
            print("\nmapping:", mapping)
            print("index each", idx_each)
            print("cate_each:", cate_each)
        ...
        for j in range(len(gt_relations[curr_file_idx]) // 3):
            ...
            print("cate name pos: ", cate_name_pos)
            print("curr_test_relation_object1", curr_test_relation_object1)
            print("curr_test_relation_object2", curr_test_relation_object2)
